...
'Image1.Picture = LoadPicture(App.path & "\Interfaces\Botónok.jpg")
...
For i = 0 To NUMSKILLS * 2 - 1
    If (i And &H1) = 0 Then
        'Command1(i).Picture = LoadPicture(App.path & "\Interfaces\BotónMás.jpg")
    Else
       ' Command1(i).Picture = LoadPicture(App.path & "\Interfaces\BotónMenos.jpg")
    End If
Next
