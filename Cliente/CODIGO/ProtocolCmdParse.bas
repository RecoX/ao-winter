...
Public Sub AuxWriteWhisper(ByVal UserName As String, ByVal Mensaje As String)
    ...
    With FontTypes(FontTypeNames.FONTTYPE_INFO)
        If nameLength = Len(PJName) Then
            Call ShowConsoleMsg("¿¡Como pretendes comunicarte contigo mismo!?", .red, .green, .blue, .bold, .italic)
            Exit Sub
        End If
    End With
...
'***************************************************
    ...
    If Left$(Comando, 1) = "/" Then
        ...
        Select Case Comando
            ...
            Case "/CANCELAR"
                Call WriteCancelarDueloAutomatico
            
            Case "/DUELOAUTOMATICO"
                If CantidadArgumentos > 0 Then
                    Call WriteDueloAutomatico(CInt(ArgumentosRaw))
                Else
                    Call ShowConsoleMsg("Escriba un numero de participantes.")
                End If
            ...
            Case "/PARTICIPAR"
                    If UserEstado = 1 Then 'Muerto
                        ...
                        Exit Sub
                    End If
                    Call WriteParticiparDueloAutomatico
            ...
            Case "/ECHARGRUPO"
                ...
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /echargrupo NICKNAME.")
                End If
            ...
            Case "/GRUPOLIDER"
                ...
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /grupolider NICKNAME.")
                End If
            ...
            Case "/ACCEPTGRUPO"
                ...
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /acceptgrupo NICKNAME.")
                End If
            ...
            Case "/PUNTOS"
                ...
                If UBound(tmpArr) = 1 Then
                        Call WritePuntos(tmpArr(0), tmpArr(1))
                Else
                Call ShowConsoleMsg("Formato incorrecto. Utiliza /Puntos NICKNAME@PUNTOS.")
                End If
            Else
                Call ShowConsoleMsg("Faltan parámetros. Utiliza /Puntos NICKNAME@PUNTOS.")
            End If
            ...
            Case "/BANACC"
                ...
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /banacc NICKNAME@MOTIVO.")
                End If
            ...
            Case "/UNBANACC"
                ...
                Else
                    'Avisar que falta el parametro
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /unbanacc NICKNAME.")
                End If
            ...
            Case "/DENUNCIASON"
                Call WriteDesDenuncia(1)
                
            Case "/DENUNCIASOFF"
                Call WriteDesDenuncia(0)
            ...
            Case "/BUSCAR"
                ...
                Else
                    Call ShowConsoleMsg("Faltan parámetros. Utilice /Buscar item.")
                End If
           ...
           '***www.lwk-foros.net***
            ...
            Case "/SETINIVAR"
                ...
                End If
            Case Else
                Call ShowConsoleMsg("¡Comando invalido!", 65, 190, 156)
        End Select
    ...
    ElseIf Left$(Comando, 1) = ";" Then
        ...
        End If
        If CantidadArgumentos > 0 Then
            Call WriteMsgGlobal(ArgumentosRaw)
        Else
            'Avisar que falta el parametro
            Call ShowConsoleMsg("Escribe un mensaje. (Escribir: ; & Espacio & Texto)")
        End If
